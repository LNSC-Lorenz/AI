...
Write-Host "  Upload Scripts to Ubuntu Server" -ForegroundColor Cyan
Write-Host "===========================================" -ForegroundColor Cyan
...
if ($proc.ExitCode -eq 0) {
    ...
    Write-Host "  ssh ${Username}@${ServerIP}   # Password: $Password" -ForegroundColor White
    ...
    Write-Host "  sudo bash ${RemotePath}postgresql-install.sh" -ForegroundColor White
} else {
    Write-Host ""
