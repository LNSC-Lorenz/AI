...
echo ""
echo "后续步骤:"
echo "1. 上传 2_install-worker-server 到 /opt/scripts/"
echo "   scp -r '2_install-worker-server' rpa@10.86.180.120:/opt/scripts/"
echo "2. 按顺序运行部署脚本:"
echo "   cd '/opt/scripts/2_install-worker-server'"
