...
<#
.SYNOPSIS
    Create cloud-init cidata ISO for Ubuntu Autoinstall (Magentic-UI)
.DESCRIPTION
...
if ([string]::IsNullOrEmpty($OutputPath)) { $OutputPath = Join-Path $PSScriptRoot "cidata.iso" }
...
Write-Host "  For Ubuntu 24.04 LTS Autoinstall (Magentic-UI)" -ForegroundColor Blue
Write-Host "=============================================================" -ForegroundColor Blue
